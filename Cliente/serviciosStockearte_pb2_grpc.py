...
class stockearteServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.traerProductos = channel.unary_unary(
                '/stockeartePackage.stockearteService/traerProductos',
                request_serializer=serviciosStockearte__pb2.mensajeVacio.SerializeToString,
                response_deserializer=serviciosStockearte__pb2.arregloProductos_4.FromString,
                _registered_method=True)
        ...
        self.traerProductosDeLaTienda = channel.unary_unary(
                ...
                _registered_method=True)
        self.traerProductosNoTienda = channel.unary_unary(
                '/stockeartePackage.stockearteService/traerProductosNoTienda',
                request_serializer=serviciosStockearte__pb2.traerProductosDeLaTiendaRequest.SerializeToString,
                response_deserializer=serviciosStockearte__pb2.arregloProductos_4.FromString,
                _registered_method=True)
        self.altaOrdenDeCompra = channel.unary_unary(
                '/stockeartePackage.stockearteService/altaOrdenDeCompra',
                request_serializer=serviciosStockearte__pb2.altaOrdenDeCompraRequest.SerializeToString,
                response_deserializer=serviciosStockearte__pb2.mensajeSimple.FromString,
                _registered_method=True)
        ...
        self.aceptarDespacho = channel.unary_unary(
                ...
                response_deserializer=serviciosStockearte__pb2.mensajeSimple.FromString,
                _registered_method=True)
        self.traerOrdenesDeCompraTienda = channel.unary_unary(
                '/stockeartePackage.stockearteService/traerOrdenesDeCompraTienda',
                request_serializer=serviciosStockearte__pb2.TiendaObject.SerializeToString,
                response_deserializer=serviciosStockearte__pb2.ordenCompraResponse.FromString,
                _registered_method=True)
        self.traerItems = channel.unary_unary(
                '/stockeartePackage.stockearteService/traerItems',
                request_serializer=serviciosStockearte__pb2.traerItemsRequest.SerializeToString,
                response_deserializer=serviciosStockearte__pb2.traerItemsResponse.FromString,
                _registered_method=True)
        self.traerOrdenesDeCompraTienda2 = channel.unary_unary(
                '/stockeartePackage.stockearteService/traerOrdenesDeCompraTienda2',
                request_serializer=serviciosStockearte__pb2.TiendaObject.SerializeToString,
                response_deserializer=serviciosStockearte__pb2.ordenCompraResponse2.FromString,
                _registered_method=True)
...
class stockearteServiceServicer(object):
    ...
    def traerProductosNoTienda(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def altaOrdenDeCompra(self, request, context):
        """proveedorService
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
    ...
    def traerOrdenesDeCompraTienda(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def traerItems(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def traerOrdenesDeCompraTienda2(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_stockearteServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'traerProductos': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=serviciosStockearte__pb2.mensajeVacio.FromString,
                    response_serializer=serviciosStockearte__pb2.arregloProductos_4.SerializeToString,
            ),
            ...
            'traerProductosNoTienda': grpc.unary_unary_rpc_method_handler(
                    servicer.traerProductosNoTienda,
                    request_deserializer=serviciosStockearte__pb2.traerProductosDeLaTiendaRequest.FromString,
                    response_serializer=serviciosStockearte__pb2.arregloProductos_4.SerializeToString,
            ),
            'altaOrdenDeCompra': grpc.unary_unary_rpc_method_handler(
                    servicer.altaOrdenDeCompra,
                    request_deserializer=serviciosStockearte__pb2.altaOrdenDeCompraRequest.FromString,
                    response_serializer=serviciosStockearte__pb2.mensajeSimple.SerializeToString,
            ),
            ...
            'traerOrdenesDeCompraTienda': grpc.unary_unary_rpc_method_handler(
                    servicer.traerOrdenesDeCompraTienda,
                    request_deserializer=serviciosStockearte__pb2.TiendaObject.FromString,
                    response_serializer=serviciosStockearte__pb2.ordenCompraResponse.SerializeToString,
            ),
            'traerItems': grpc.unary_unary_rpc_method_handler(
                    servicer.traerItems,
                    request_deserializer=serviciosStockearte__pb2.traerItemsRequest.FromString,
                    response_serializer=serviciosStockearte__pb2.traerItemsResponse.SerializeToString,
            ),
            'traerOrdenesDeCompraTienda2': grpc.unary_unary_rpc_method_handler(
                    servicer.traerOrdenesDeCompraTienda2,
                    request_deserializer=serviciosStockearte__pb2.TiendaObject.FromString,
                    response_serializer=serviciosStockearte__pb2.ordenCompraResponse2.SerializeToString,
            ),
    }
...
class stockearteService(object):
    ...
    def traerProductos(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/stockeartePackage.stockearteService/traerProductos',
            serviciosStockearte__pb2.mensajeVacio.SerializeToString,
            serviciosStockearte__pb2.arregloProductos_4.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def traerProductosNoTienda(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    def altaOrdenDeCompra(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/stockeartePackage.stockearteService/altaOrdenDeCompra',
            serviciosStockearte__pb2.altaOrdenDeCompraRequest.SerializeToString,
            serviciosStockearte__pb2.mensajeSimple.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def traerOrdenesDeCompraTienda(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/stockeartePackage.stockearteService/traerOrdenesDeCompraTienda',
            serviciosStockearte__pb2.TiendaObject.SerializeToString,
            serviciosStockearte__pb2.ordenCompraResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def traerItems(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/stockeartePackage.stockearteService/traerItems',
            serviciosStockearte__pb2.traerItemsRequest.SerializeToString,
            serviciosStockearte__pb2.traerItemsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def traerOrdenesDeCompraTienda2(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/stockeartePackage.stockearteService/traerOrdenesDeCompraTienda2',
            serviciosStockearte__pb2.TiendaObject.SerializeToString,
            serviciosStockearte__pb2.ordenCompraResponse2.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
